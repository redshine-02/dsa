import java.util.*;
public class delete_node_with_given_val{
...
//**********************     SOLUTION       *******************************************************//
    public TreeNode removeLeafNodes(TreeNode root, int data) {
        if(root == null){
            return null;
        }
        root.left = removeLeafNodes(root.left,data);
        root.right = removeLeafNodes(root.right,data);
